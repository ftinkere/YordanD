<script setup lang="ts">
  const feat = [
      ...
      [['ʊ̈', /ʊ̈/g], ['U\\', /U\\/g], ['U\\', /U\\/g], 'near-close central rounded-sm vowel'],
      [['ʉ̞', /ʉ̞/g], ['U\\', /U\\/g], ['U\\', /U\\/g], 'near-close central rounded-sm vowel'],
      [['ħ', /ħ/g], ['X\\', /X\\/g], ['X\\', /X\\/g], 'voiceless pharyngeal fricative'],
      [['ˑ', /ˑ/g], [':\\', /:\\/g], [':\\', /:\\/g], 'half long'],
      [['ɘ', /ɘ/g], ['@\\', /@\\/g], ['@\\', /@\\/g], 'close-mid central unrounded vowel'],
      [['ɞ', /ɞ/g], ['3\\', /3\\/g], ['3\\', /3\\/g], 'open-mid central rounded-sm vowel'],
      [['ɶ', /ɶ/g], ['&', /&/g], ['&\\', /&\\/g], 'open front rounded-sm vowel'],
  ...
  //[['', //g], ['<', /</g], ['<', /</g], 'begin nonsegmental notation (e.g., SAMPROSA)'],
      ...
      [['̜', /̜/g], ['_c', /_c/g], ['_c', /_c/g], 'less rounded-sm'],
      ...
      [['̹', /̹/g], ['_O', /_O/g], ['_O', /_O/g], 'more rounded-sm'],
  ...
  //[['', //g], ['/', ///g], ['/', ///g], 'indeterminacy in French vowels'],
      ...
      [['ʉ', /ʉ/g], ['}', /}/g], ['u\\', /u\\/g], 'close central rounded-sm vowel'],
      [['ʔ', /ʔ/g], ['?', /\?/g], ['?', /\?/g], 'glottal stop'],
      [['ɨ', /ɨ/g], ['1', /1/g], ['1', /1/g], 'close central unrounded vowel'],
      [['ø', /ø/g], ['2', /2/g], ['2', /2/g], 'close-mid front rounded-sm vowel'],
      ...
      [['ɵ', /ɵ/g], ['8', /8/g], ['8', /8/g], 'close-mid central rounded-sm vowel'],
      [['œ', /œ/g], ['9', /9/g], ['9', /9/g], 'open-mid front rounded-sm vowel'],
      ...
      [['ɔ', /ɔ/g], ['O', /O/g], ['O', /O/g], 'open-mid back rounded-sm vowel'],
      [['ɒ', /ɒ/g], ['Q', /Q/g], ['Q', /Q/g], 'open back rounded-sm vowel'],
      ...
      [['ʊ', /ʊ/g], ['U', /U/g], ['U', /U/g], 'near-close back rounded-sm vowel'],
      ...
      [['ʏ', /ʏ/g], ['Y', /Y/g], ['Y', /Y/g], 'near-close front rounded-sm vowel'],
   ...
   function x2i(text: string) {

      let new1 = text;

      for (let i = 0; i < feat.length; i++) {
          const pat = feat[i][1][1];
